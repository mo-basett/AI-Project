...
class App:
    def __init__(self, root):
        ...
        label_font = tkFont.Font(family='sans-serif', size=14)
        outputt["font"] = label_font
        outputt.place(x=380, y=355, width=100, height=25)
        ...
        # Message creation
        self.MessageOut = tk.Message(root, font=tkFont.Font(family='sans-serif', size=12,weight='bold'), bg="black", fg="white")
        self.MessageOut["justify"] = "center"
        self.MessageOut.place(x=470, y=320, width=150, height=100)
    def get_inputs(self):
        entry_values = []
    ...
    def GButton_812_command(self):
        ...
        if any(entry == '' for entry in inputtext):
            ...
            if response.status_code == 200:
                ...
                dt_output = "\n".join([f"DT: {pred}" for pred in dt_predictions])
